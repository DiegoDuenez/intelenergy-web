...
<div id="servicios__background"></div>  
    <div class="servicios__container">
        ...
        <div class="servicios__content">
            <ul class="servicios__list">
                ...
                <li><i class="fa-solid fa-circle"></i> Desarrollo de Ingenieria</li>
                <li><i class="fa-solid fa-circle"></i> Soluciones Integrales de Sistemas de Generación</li>
                <li><i class="fa-solid fa-circle"></i> Cursos a clientes</li>
                <li><i class="fa-solid fa-circle"></i> Puesta en Servicio y Comisionamiento de Equipos</li>
                <li><i class="fa-solid fa-circle"></i> Mantenimientos Preventivos a Tableros de Distribución Electrica</li>
            </ul>
        </div>
    </div>
    ...
    <!--<div class="servicios__image">
        <img src="assets/Servicios.png" alt="" class="servicios__img" data-aos="fade-left">
    </div>-->
</section>